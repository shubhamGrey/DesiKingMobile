...
const ProfileScreen = () => {
  ...
  const menuItems = [
    { icon: 'bag-outline', title: 'My Orders', onPress: () => {} },
    { icon: 'location-outline', title: 'Addresses', onPress: () => {} },
    { icon: 'heart-outline', title: 'Wishlist', onPress: () => {} },
    { icon: 'notifications-outline', title: 'Notifications', onPress: () => {} },
    { icon: 'help-circle-outline', title: 'Help & Support', onPress: () => navigation.navigate('Contact') },
    { icon: 'information-circle-outline', title: 'About Us', onPress: () => navigation.navigate('About') },
  ];
